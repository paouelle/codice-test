...
import org.codice.dominion.pax.exam.options.karaf.extensions.DeleteRuntimeFolderExtension;
...
import org.codice.dominion.pax.exam.options.karaf.extensions.KeepRuntimeFolderExtension;
import org.codice.dominion.pax.exam.options.karaf.extensions.ReplaceFileExtension;
import org.codice.dominion.pax.exam.options.karaf.extensions.UpdateConfigFileExtension;
...
public class OptionExtensionFactory implements Option.Factory {
  ...
  static {
    ...
    map.put(KarafOptions.DeleteRuntimeFolder.class, new DeleteRuntimeFolderExtension());
    ...
    map.put(KarafOptions.KeepRuntimeFolder.class, new KeepRuntimeFolderExtension());
    map.put(KarafOptions.ReplaceFile.class, new ReplaceFileExtension());
    map.put(
        KarafOptions.SetLogLevel.class,
        new org.codice.dominion.pax.exam.options.karaf.extensions.SetLogLevelExtension());
    map.put(KarafOptions.UpdateConfigFile.class, new UpdateConfigFileExtension());
